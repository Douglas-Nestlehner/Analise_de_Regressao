...
dados = pd.read_excel("E:/Trabalho_01/base_original.xlsx")
dados
...
modelo_coefs = [modelo.params["x1"],modelo.params["x2"],modelo.params["x3"],modelo.params["x4"],modelo.params["x5"],modelo.params["x6"]]
...
modelo2_coefs = [modelo2.params["x1"],modelo2.params["x2"],modelo2.params["x3"],modelo2.params["x4"],modelo2.params["x5"],modelo2.params["x6"]]
...
covariaveis_transf = np.hstack((x1_transf,x2_transf,x3_transf,x4_transf,x5_transf,x6_transf))
covariaveis_transf_df = pd.DataFrame(covariaveis_transf, columns= ["x1_transf", "x2_transf", "x3_transf", "x4_transf", "x5_transf", "x6_transf"])
...
modelo3 = ols(formula='Y_transf~x1_transf+x2_transf+x3_transf+x4_transf+x5_transf+x6_transf', data=covariaveis_transf_df).fit()
modelo3_intercept = modelo3.params["Intercept"]
modelo3_coefs = [modelo3.params["x1_transf"],modelo3.params["x2_transf"],modelo3.params["x3_transf"],modelo3.params["x4_transf"],modelo3.params["x5_transf"],modelo3.params["x6_transf"]]
...
modelo_final = ols(formula='Y_transf~x1_transf+x2_transf+x3_transf+x4_transf+x6_transf', data=covariaveis_transf_df).fit()
modelo_final_intercept = modelo_final.params["Intercept"]
modelo_final_coefs = [modelo_final.params["x1_transf"],modelo_final.params["x2_transf"],modelo_final.params["x3_transf"],modelo_final.params["x4_transf"],modelo_final.params["x6_transf"]]
